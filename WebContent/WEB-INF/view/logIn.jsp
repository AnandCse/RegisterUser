	...
	<form action="logIn" method="POST">
		...
		<div class="container" style="border: 2px solid #a1a1a1">
			<div class="form-group">
				...
				<div class="row">
					<div class="col-md-3 col-sm-3 col-xs-3">EmailId</div>
			...
			<div class="form-group">
				...
				<div class="row">
					<div class="col-md-3 col-sm-3 col-xs-3">Re-EnterPassWord</div>
					<div class="col-md-3 col-sm-3 col-xs-3">
			...
			<div class="form-group">
				...
				<div class="row">
					<div class="col-md-2 col-md-offset-3 col-sm-2 col-sm-offset-3 col-xs-2 col-xs-offset-3">
